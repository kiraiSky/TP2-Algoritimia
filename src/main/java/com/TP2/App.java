...
public class App {
    ...
    public static void main(String[] args) {
        try {
            ...
            // // Criando pessoas
            // Pessoa pessoa1 = new Pessoa("Andre Silva", new LocalDate(2001, 0, 19), 259276928);
            // Pessoa pessoa2 = new Pessoa("Maria Santos", new LocalDate(1995, 5, 12), 123456789);
            // Pessoa pessoa3 = new Pessoa("João Oliveira", new LocalDate(1980, 9, 30), 987654321);
            // Pessoa pessoa4 = new Pessoa("Ana Souza", new LocalDate(1973, 2, 8), 456789123);
            ...
            FileWriterTXT.saveToFile(pessoas);
